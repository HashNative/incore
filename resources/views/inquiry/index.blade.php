                ...
                <div>
                  <div class="card">
                        <div class="card-header p-2">
                          ...
                          <li class="nav-item"><a class="nav-link" href="#activity-a" data-toggle="tab">All</a></li>
                          @foreach($ids as $id)
                            <li class="nav-item"><a class="nav-link" href="#activity-{{$id->follow_up}}" data-toggle="tab">{{$id->follow_up}}</a></li>
                            @endforeach
                        ...
                        <div class="card-body">
                          ...
                          @foreach($ids as $id)
                            <div class="tab-pane" id="activity-{{$id->follow_up}}">
                          ...
                          @endforeach
                          <div class="active tab-pane" id="activity-a">
                              <table id="example1" class="table table-bordered table-striped table-responsive ">
                                    <thead>
                                    <tr>
