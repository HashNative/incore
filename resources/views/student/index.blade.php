        ...
        <td>{{ $student->date}}</td>
           ...
           <td>
            <form action = "{{route('student.destroy',$student->id)}}" method = "POST" onsubmit="if(!confirm('Are you sure')){return false;}">
                ...
                <a href="{{route('student.show',$student->id)}}" tittle="view details" class="btn btn-xs " style="color:#0066ff";>
                    <i class="fa fa-eye"> </i>
                </a>
                
                
                <a href="{{route('student.edit',$student->id)}}" tittle="edit details" class="btn btn-xs " style="color:#ffc107";>
                ...
                <input type = "hidden" name = "_method" value = "delete"> 
                    {{csrf_field()}}
                    <button type="submit"  class="btn  btn-xs " style="color:#cc0000";><i tittle="delete details" class="fa fa-trash"></i></button>
                </form>
