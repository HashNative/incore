                ...
                <div class="col-md-2">
                  <div class="from-group">
                    ...
                    <select type="text" name="title" id="title" value="{{$staff ->title}}" class="form-control " required>
                      ...
                      <option <?php if (($staff->title) == 'Mr') {
                                echo 'selected';
                              } ?>>Mr</option>
                      <option <?php if (($staff->title) == 'Miss') {
                                echo 'selected';
                              } ?>>Miss</option>
                      <option <?php if (($staff->title) == 'Miss') {
                                echo 'selected';
                ...
                <div class="col-md-4">
                  <div class="from-group">
                    ...
                    <select type="text" name="gender" id="gender" value="{{$staff ->gender}}" class="form-control" required>
                      ...
                      <option <?php if (($staff->gender) == 'Mr') {
                                echo 'selected';
                              } ?>>Male</option>
                      <option <?php if (($staff->gender) == 'Miss') {
                                echo 'selected';
                              } ?>>Female</option>
                    </select>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="from-group">
                    ...
                    <select type="text" name="languages[]" id="languages" class="form-control " required multiple>
                      ...
                      <option <?php if (in_array('English', explode(',', $staff->languages))) {
                                echo 'selected';
                              } ?>>English</option>
                      <option <?php if (in_array('Tamil', explode(',', $staff->languages))) {
                                echo 'selected';
                              } ?>>Tamil</option>
                      <option <?php if (in_array('Sinhala', explode(',', $staff->languages))) {
                                echo 'selected';
                              } ?>>Sinhala</option>
                ...
                <div class="col-md-6 from-group">
                  ...
                  <div class="col-md-6 form-group">
                    ...
                    <select type="text" name="type" id="type" class="form-control">
                      <option <?php if (($staff->type) == 'Admin') {
                                echo 'selected';
                              } ?>>Admin</option>
                      <option  <?php if (($staff->type) == 'Staff') {
                                echo 'selected';
                              } ?>>Staff</option>
                    </select>
                  </div>
